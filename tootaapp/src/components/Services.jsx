...
const servicesList = [
  {
    icon: <img src="/images/send parcels.png" alt="Parcel Delivery" className="w-32 h-32 object-cover rounded-lg" />,
    title: (
  ...
  {
    icon: <img src="/images/one.png" alt="Furniture Moving" className="w-32 h-32 object-cover rounded-lg" />,
    title: (
      <span className="flex items-center gap-2 text-orange-500">
  ...
  {
    icon: <img src="/images/calend.png" alt="Scheduled Delivery" className="w-32 h-32 object-cover rounded-lg" />,
    title: (
      <span className="flex items-center gap-2 text-orange-500">
      ...
      <footer className="bg-gray-100 text-black text-center p-6 mt-12 relative">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="flex items-center justify-center space-x-3 mb-4">
            <img src="/images/logo.png" alt="Toota Logo" className="w-14 h-14 object-cover" />
          ...
          <div className="absolute bottom-4 left-4 text-sm">
            ...
            <select
              ...
              className="bg-gray-200 text-black p-1 rounded border border-gray-400"
            >
